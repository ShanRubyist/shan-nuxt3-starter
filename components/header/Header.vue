        ...
        <div class="h-auto w-screen bg-black text-white">
            ...
            <nav class="font-inter mx-auto h-auto w-full max-w-[1600px] lg:relative lg:top-0"
                ...
                <div
                    ...
                    <a href="#">
                        <img src="https://uploads-ssl.webflow.com/646f65e37fe0275cfb808405/646f66cdeeb4ddfdae25a26c_%5BA%5D--Navbar%20Brand.png"
                    ...
                    <div class="mt-14 flex flex-col space-y-8 lg:mt-0 lg:flex lg:flex-row lg:space-x-1 lg:space-y-0"
                        ...
                        <div class="relative flex flex-col">
                            <a x-on:click.prevent="menuOne = !menuOne" href="#"
                                class="flex flex-row rounded-lg hover:text-[#c9fd02] lg:px-6 lg:py-4"
                                x-bind:class="menuOne ? ' text-[#c9fd02] ' : 'text-white  ' ">Component <svg
                                    x-bind:class="menuOne ? 'rotate-180' : 'rotate-0' " class="fill-current transition"
                                    style="width: 24px; height: 24px" viewBox="0 0 24 24">
                                    <path d="M7.41,8.58L12,13.17L16.59,8.58L18,10L12,16L6,10L7.41,8.58Z" />
                                </svg>
                            </a>
                            <!-- DROP DOWN MENU ONE -->
                            <div class="lg:px-75 z-50 flex w-full flex-col rounded-lg bg-[#181818] px-5 py-5 lg:absolute lg:top-20 lg:w-[800px] lg:flex-row lg:flex-wrap lg:py-7 lg:shadow-[0_16px_64px_-15px_rgba(45,96,173,0.15)] xl:w-[950px]"
                        ...
                        <a href="#" class="font-inter rounded-lg hover:text-[#c9fd02] lg:px-6 lg:py-4">Templates</a>
                        <a href="#" class="font-inter rounded-lg hover:text-[#c9fd02] lg:px-6 lg:py-4">Pricing</a>
                        <a href="#"
                    ...
                    <div class="flex flex-col space-y-8 lg:flex lg:flex-row lg:space-x-3 lg:space-y-0"
                        ...
                        <a href="https://build.flowspark.co/template" target="_blank"
                            class="inline-block rounded-full bg-white px-5 py-3 text-center font-bold text-black transition hover:border-black hover:bg-[#c9fd02]">Get
                            Started</a>
                    </div>
                    <!-- BURGER MENU -->
